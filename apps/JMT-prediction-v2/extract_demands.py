...
Also output arrival rates (req/s) for each class from log duration AND
per-(class, station) VARIANCE so we can fit HyperExp / Lognormal distributions
(both of which calibrate to (mean, variance) per service phase).
