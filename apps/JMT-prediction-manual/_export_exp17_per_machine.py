#!/usr/bin/env python3
"""Export per-machine measured/predicted/MRE tables for Exp 17 (Pure MLE no-shift).
...
for stat in ("mean", "median", "p95"):
    print(f"\n## {stat.upper()} per machine, Exp 17 (мс)\n")
...
print("\n## Aggregate |MRE| Exp 17 per machine (mean of 4 classes)\n")
